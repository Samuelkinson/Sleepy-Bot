module.exports = (Discord, msg, c, country, flag ) =>{
	...
	.addFields(
		...
		{name: '☢️Casos Criticos', value: formatNumber(c.cases.critical), inline: true},
        {name: '😴Casos Recuperados', value: formatNumber(c.cases.recovered), inline: true},
        )
	.addFields(
			{name: '☠️Total de Mortes', value: formatNumber(c.deaths.total), inline: true},
			{name: '☠️Novas Mortes', value: formatNumber(c.deaths.new), inline: true},
